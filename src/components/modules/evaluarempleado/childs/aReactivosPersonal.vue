        ...
        <template slot="items" slot-scope="props">
          <tr v-if="!isMobile">
            ...
            <v-radio-group v-model="props.item.Result" row class="mt-2" v-on="ratingReactivo(props.item)">
              ...
              <v-radio label="8" :value="8" color="blue darken-3" :disabled="g_loginUser.allowEvaluation=='false'"></v-radio>
              <v-radio label="10" :value="10"  color="blue darken-3"  :disabled="g_loginUser.allowEvaluation=='false'"></v-radio>
            </v-radio-group>
