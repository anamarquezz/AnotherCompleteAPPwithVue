<template>
  <div class="row containerswiper">
    <div class="col-12 col-sm-12 col-md-6 col-lg-5 col-xl-3 backgroundfondo ">
    ...
    <div class="col-12 col-sm-12 col-md-5 col-lg-7 col-xl-8 height100 ">
      ...
      if (event.which === 13) {
        if (esto.validLogin()) {
          ...
          this.$store.dispatch("set_showMessage", {
            message:
              "Usuario o Contraseña no capturadas, favor de ingresar los datos correspondientes",
            show: true,
            title: "Error",
            showregresar: false,
            colorThema: "red"
